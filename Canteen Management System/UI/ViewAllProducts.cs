    ...
    public partial class ViewAllProducts : Form
    {
        ...
        private void ProductCategoryComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ProductCategoryComboBox.SelectedIndex == 0)
            {
                ...
                {
                    ProductsGridView.Rows.Add(ProductDetail.ID, ProductDetail.Name, ProductDetail.Price, ProductDetail.Category, ProductDetail.Description, ProductDetail.Picture,ProductDetail.Active);
                }
            }
            else if (ProductCategoryComboBox.SelectedIndex > 0)
            {
                ...
                {
                    ProductsGridView.Rows.Add(ProductDetail.ID, ProductDetail.Name, ProductDetail.Price, CategoryName, ProductDetail.Description, ProductDetail.Picture,ProductDetail.Active);
                }
            }
        }
        ...
        private void ProductsGridView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                else if (ProductsGridView.Columns[e.ColumnIndex].Name == "EditProductColumn")
                {
                    ...
                    string Active = ProductsGridView.Rows[e.RowIndex].Cells["ActiveColumn"].Value.ToString();

                    UpdateProducts UpdateProductForm = new UpdateProducts(ProductID, ProductName, ProductPrice, ProductCategory, ProductDescription, ProductPicture,Active);
                    UpdateProductForm.ShowDialog();
                        ...
                        ProductsGridView.Rows[e.RowIndex].Cells["ActiveColumn"].Value = UpdatedProductDetail.Active;
